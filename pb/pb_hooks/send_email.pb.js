...
routerAdd('POST', '/api/send_email', (e) => {
	...
	const textContent = payload.textContent; // Sera éventuellement généré plus tard si manquant
	const recipients = payload.recipients || [];
	const recipientGroups = payload.recipientGroups || [];
	const fallbackRecipientGroups = payload.fallbackRecipientGroups || [];
