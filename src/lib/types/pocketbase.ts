...
export type SpacesOptionsRecord<Tcategories = unknown, Toptions = unknown, TpublicSiteMenus = unknown, TpublicSiteTheme = unknown, Trooms = unknown, Ttasks = unknown> = {
	categories?: null | Tcategories
	created?: IsoDateString
	id: string
	mailSend?: HTMLString
	options?: null | Toptions
	publicSiteMenus?: null | TpublicSiteMenus
...
export type SpacesOptionsResponse<Tcategories = unknown, Toptions = unknown, TpublicSiteMenus = unknown, TpublicSiteTheme = unknown, Trooms = unknown, Ttasks = unknown, Texpand = unknown> = Required<SpacesOptionsRecord<Tcategories, Toptions, TpublicSiteMenus, TpublicSiteTheme, Trooms, Ttasks>> & BaseSystemFields<Texpand>
